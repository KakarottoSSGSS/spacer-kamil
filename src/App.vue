...
<script>
  ...
  // funckja debounce opoznia wykonanie eventu
  export default {
    name: 'Search',
    components: {
      Claim,
    ...
    data() {
      return {
        // search value musi miec wartos gdy uzywamy vmodel moze ona byc zerowa
        modalItem: null,
        modalOpen: false,
        loading: false,
        step: 0,
...
.loader:after {
  ...
  border-color: #13ed4a transparent #13ed4a transparent;
